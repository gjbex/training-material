...
def create_graph():
    ...
    citations.add_edge(refs['A00'], refs['B02a'])
    citations.add_edge(refs['A00'], refs['B02b'])
    citations.add_edge(refs['A00'], refs['E02'])
    citations.add_edge(refs['A00'], refs['A03'])
    citations.add_edge(refs['A00'], refs['T04'])
